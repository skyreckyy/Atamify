...
<div id="wrapper">
    <nav class="navbar navbar-default top-navbar" role="navigation">
        <div class="navbar-header">
            ...
            <a class="navbar-brand waves-effect waves-dark" href="index.html"><i class="large material-icons">timeline</i> <strong>{{ config('app.name', 'Laravel') }}</strong></a>
...
<script src="{{ asset('js/Lightweight-Chart/jquery.chart.min.js') }}"></script>
